if (location.hostname.indexOf("searchtechnologies") > -1) {
    ...
    document.write("<style type='text/css'>   .result-list{display:none;} .smallField>span {display:none;} .smallField>br{display:none;}  #f_categories>dl>dd {display:none; } #f_categories>div>a{display:none;} #f_year { display:none ;} #f_type {display:none;} #f_author {display:none} </style>");
